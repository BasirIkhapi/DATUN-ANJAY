            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-2 bg-white rounded-[3rem] p-10 border border-slate-100 shadow-xl flex flex-col justify-center text-left">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        {{-- FITUR EKSKLUSIF ADMIN (TAMBAHAN LAPORAN SKRIPSI) --}}
                        @if(Auth::user()->role === 'admin')
                            ...
                            {{-- 4. BARU: Laporan Durasi (Skripsi) --}}
                            <a href="{{ route('perkara.arsip.durasi') }}" target="_blank" class="flex items-center gap-3 bg-amber-500 text-white px-6 py-4 rounded-2xl font-black text-[9px] uppercase tracking-widest hover:bg-amber-600 transition-all shadow-lg active:scale-95">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                Analisis Durasi
                            </a>

                            {{-- 5. BARU: Log Aktivitas (Skripsi) --}}
                            <a href="{{ route('perkara.arsip.cetakLog') }}" target="_blank" class="flex items-center gap-3 bg-indigo-600 text-white px-6 py-4 rounded-2xl font-black text-[9px] uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-lg active:scale-95">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0zM3 12h.01M21 12h.01M12 3h.01M12 21h.01"/></svg>
                                Audit Log
                            </a>
