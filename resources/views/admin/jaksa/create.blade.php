<x-app-layout>
    ...
    <div class="py-12 bg-gradient-to-b from-gray-50 to-emerald-50/30 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            @if ($errors->any())
                <div class="mb-8 p-6 bg-red-50 border-l-8 border-red-500 rounded-3xl shadow-xl shadow-red-100 animate-bounce">
                    <div class="flex items-center gap-4 mb-3">
                        <svg width="24" height="24" class="text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <h4 class="text-sm font-black text-red-700 uppercase tracking-widest">Data Gagal Disimpan!</h4>
                    </div>
                ...
                <form action="{{ route('perkara.store') }}" method="POST" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nomor_perkara" value="{{ old('nomor_perkara') }}" required placeholder="Contoh: 01/Pdt.G/2026/PN Bjm" 
                                class="w-full px-6 py-4 bg-gray-50 border-gray-100 border-2 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 focus:bg-white font-bold text-gray-700 transition-all outline-none text-sm uppercase">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="jaksa_id" required class="w-full px-6 py-4 bg-gray-50 border-gray-100 border-2 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 focus:bg-white font-bold text-gray-700 transition-all outline-none text-sm">
                                <option value="">Pilih Personel Jaksa...</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="penggugat" value="{{ old('penggugat') }}" required placeholder="Nama Instansi/Perorangan"
                                class="w-full px-6 py-4 bg-gray-50 border-gray-100 border-2 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 focus:bg-white font-bold text-gray-700 transition-all outline-none text-sm uppercase">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="tergugat" value="{{ old('tergugat') }}" required placeholder="Nama Instansi/Perorangan"
                                class="w-full px-6 py-4 bg-gray-50 border-gray-100 border-2 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 focus:bg-white font-bold text-gray-700 transition-all outline-none text-sm uppercase">
                        </div>
                    </div>
